...
RedMetrics offers open source game analytics. It is made up of a RESTful web service and a basic website that allows teachers and researchers to track game metrics, then download the raw data for offline analysis. Limited support for groups is also available.
